                        ...
                        <div className="flex flex-wrap mt-14">
                            <div className="My-card basis-1/2 px-24 my-5 ">
                                <div className=" bg-white rounded-xl py-7 px-6" >
                                    ...
                                    <Button className='mt-6 text-2xl' type='submit' fullWidth onClick={() => handleDaftarClick(100, 'tk')} >Daftar</Button>
                                </div>
                            </div>
                            <div className="My-card basis-1/2 px-24 my-5 ">
                                <div className=" bg-white rounded-xl py-7 px-6" >
                                    ...
                                    <Button className='mt-6 text-2xl' type='submit' fullWidth onClick={() => handleDaftarClick(200, 'sd')}>Daftar</Button>
                                </div>
                            </div>
                            <div className="My-card basis-1/2 px-24 my-5 ">
                                <div className=" bg-white rounded-xl py-7 px-6" >
                                    ...
                                    <Button className='mt-6 text-2xl' type='submit' fullWidth onClick={() => handleDaftarClick(300, 'smp-sma')}>Daftar</Button>
                                </div>
                            </div>
                            <div className="My-card basis-1/2 px-24 my-5 ">
                                <div className=" bg-white rounded-xl py-7 px-6" >
                                    ...
                                    <Button className='mt-6 text-2xl' type='submit' fullWidth onClick={() => handleDaftarClick(400, 'pondok')}>Daftar</Button>
                                </div>
                            </div>
                        </div>
                    </div>
