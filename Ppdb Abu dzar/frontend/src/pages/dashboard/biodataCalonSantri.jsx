                    ...
                    <Form method='POST' ref={componentRef} className='mx-4'>
                        ...
                        <div className="grid gap-6 mb-6 md:grid-cols-2">
                            <div>
                                ...
                                <Field type="text" name="no_kk" id="no_kk" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                ...
                                <div>
                                    <div>
                                        ...
                                        {/* <Field type="number" name="jenis_kelamin" id="jenis_kelamin" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                            placeholder="Isi NISN"
                                            required /> */}
                                        <Dropdown value={values.jenis_kelamin == 1 ? 'Perempuan' : 'Laki-laki'}
                            ...
                            <div className="grid gap-6 md:grid-cols-2">
                                ...
                                <div>
                                    <div>
                                        ...
                                        <Dropdown value={values.status_dalam_keluarga === 'anak' ? 'Anak' : 'Anak Angkat'}
                                            onChange={(e) => {
                                                // console.log(e.value)
                                                setValues({
                                                    ...values,
                        ...
                        <div className="grid gap-6 mb-6 md:grid-cols-2">
                            <div>
                                <div>
                                    ...
                                    <Dropdown value={values.jenis_tempat_tinggal ?? 'Pilih Jenis Tempat Tinggal'}
                                        onChange={(e) => {
                                            // console.log(e.value)
                                            setValues({
                                                ...values,
